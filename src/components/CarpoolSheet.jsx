  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end">
      ...
      <div className="relative w-full bg-white rounded-t-3xl px-5 pt-5 pb-10 flex flex-col gap-5">
        ...
        {role === 'driving' && (
          <div>
            <p className="font-[Montserrat] text-xs font-semibold text-capp-dark/50 uppercase tracking-wider mb-2">Seats available</p>
            <div className="flex items-center gap-4">
              ...
              <span className="font-[League_Spartan] font-bold text-capp-dark text-2xl w-8 text-center">{seats}</span>
              <button
