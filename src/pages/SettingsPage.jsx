    ...
    <div className="min-h-screen bg-capp-warm-bg pb-nav">
      ...
      <div className="px-4 pt-12 pb-5 flex items-center gap-3 border-b border-capp-dark/5">
        ...
        <div className="flex items-center gap-2 flex-1">
          <div className="w-7 h-7 rounded-lg bg-capp-coral flex items-center justify-center">
            <span className="font-[Fraunces] text-capp-dark text-sm font-bold">C</span>
          </div>
          <span className="font-[Fraunces] font-bold text-capp-dark text-lg">Settings</span>
        </div>
        {saved && (
          <span className="font-[DM_Sans] text-xs font-semibold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full">
            Saved ✓
          </span>
        )}
      </div>
      ...
      <div className="px-4 pt-6 flex flex-col gap-5">
        ...
        <section className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 pt-4 pb-2">
            <p className="font-[DM_Sans] text-[11px] font-bold text-capp-dark/35 uppercase tracking-wider">
              My profile
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 px-4 pb-4">
            <div className="w-16 h-16 rounded-full bg-capp-coral flex items-center justify-center shadow-md shrink-0">
              <span className="font-[Fraunces] font-bold text-capp-dark text-xl">{initials}</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-[Fraunces] font-bold text-capp-dark text-lg leading-tight truncate">{user?.name}</p>
              <p className="font-[DM_Sans] text-sm text-capp-dark/45 truncate">{user?.email}</p>
            </div>
            <button
            ...
            <div className="border-t border-capp-dark/5 px-4 py-4 flex flex-col gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full font-[DM_Sans] text-base bg-capp-warm-bg border-2 border-capp-dark/10 focus:border-capp-coral/50 rounded-2xl px-4 py-3 focus:outline-none transition-colors"
                />
              </div>
              <div>
                <label className="font-[DM_Sans] text-xs font-semibold text-capp-dark/55 uppercase tracking-wider mb-1.5 block">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 bg-capp-coral text-capp-dark font-[DM_Sans] font-semibold py-3 rounded-2xl active:scale-95 transition-transform"
                >
                  Save changes
                </button>
                <button
                  onClick={() => setEditingProfile(false)}
                  className="flex-1 bg-capp-dark/5 text-capp-dark/60 font-[DM_Sans] font-medium py-3 rounded-2xl active:scale-95 transition-transform"
                >
                  Cancel
                </button>
              </div>
        ...
        <section className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          {kids.length === 0 ? (
            <div className="px-4 pb-5 pt-2 text-center">
              <p className="font-[DM_Sans] text-sm text-capp-dark/45 mb-3">No kids added yet</p>
              <button
                onClick={() => navigate('/add-kid')}
                ...
                <div key={kid.id} className="flex items-center gap-3 px-4 py-3.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {kid.interests?.length > 0 && (
                      <p className="font-[DM_Sans] text-xs text-capp-dark/40 truncate mt-0.5">
                        {kid.interests.join(' · ')}
                      </p>
                    )}
                    <div className="flex gap-2 mt-1 flex-wrap">
                      {kid.environment && (
                        <span className="font-[DM_Sans] text-[10px] text-capp-dark/40 bg-capp-dark/5 px-1.5 py-0.5 rounded-full capitalize">
        ...
        <section className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 pt-4 pb-2">
            <p className="font-[DM_Sans] text-[11px] font-bold text-capp-dark/35 uppercase tracking-wider">Community</p>
          </div>
          <div className="flex flex-col divide-y divide-capp-dark/5">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-[DM_Sans] text-sm font-medium text-capp-dark">Share CAMPP</p>
                  <p className="font-[DM_Sans] text-xs text-capp-dark/40">
                    {copied ? 'Link copied!' : 'Spread the word with other camp parents'}
                  </p>
                </div>
              </div>
              <span className={`font-[DM_Sans] text-xs font-semibold shrink-0 ${copied ? 'text-emerald-500' : 'text-capp-coral'}`}>
                {copied ? 'Copied ✓' : 'Share →'}
              </span>
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-[DM_Sans] text-sm font-medium text-capp-dark">Submit a camp suggestion</p>
                  <p className="font-[DM_Sans] text-xs text-capp-dark/40">Know a great camp we should add?</p>
                </div>
              </div>
        ...
        <section className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 pt-4 pb-2">
            <p className="font-[DM_Sans] text-[11px] font-bold text-capp-dark/35 uppercase tracking-wider">App</p>
          </div>
          <div className="flex flex-col divide-y divide-capp-dark/5">
            <button
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-[DM_Sans] text-sm font-medium text-capp-dark">Browse camps</span>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-lg">☀️</span>
                <span className="font-[DM_Sans] text-sm font-medium text-capp-dark">My Summer</span>
              </div>
              <span className="text-capp-dark/25 text-sm">→</span>
            </button>
            <button
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-[DM_Sans] text-sm font-medium text-capp-dark">CAMPP Assistant</span>
              </div>
              <span className="text-capp-dark/25 text-sm">→</span>
            </button>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 pt-4 pb-2">
            <p className="font-[DM_Sans] text-[11px] font-bold text-capp-dark/35 uppercase tracking-wider">Support</p>
          </div>
        ...
        <button
          ...
          className="w-full bg-white rounded-2xl shadow-sm py-4 font-[DM_Sans] font-semibold text-red-400 active:scale-95 transition-transform"
        >
          Sign out
        </button>

        <p className="font-[DM_Sans] text-xs text-capp-dark/25 text-center pb-4">CAMPP · North County San Diego</p>
          ...
          <div className="relative w-full bg-white rounded-t-3xl px-5 pt-6 pb-10">
            {suggestionSent ? (
              <div className="flex flex-col items-center text-center py-6 gap-3">
                ...
                <h3 className="font-[Fraunces] font-bold text-capp-dark text-xl">Thanks for the tip!</h3>
                <p className="font-[DM_Sans] text-sm text-capp-dark/55 leading-relaxed">
              ...
              <>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="font-[Fraunces] font-bold text-capp-dark text-lg leading-tight">
                      Suggest a camp
                    </h3>
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    rows={4}
                    autoFocus
                    className="w-full font-[DM_Sans] text-base bg-capp-warm-bg border-2 border-capp-dark/10 focus:border-capp-coral/50 rounded-2xl px-4 py-3.5 focus:outline-none transition-colors resize-none"
                  />
                </div>
      ...
      {showSignOutConfirm && (
        <div className="fixed inset-0 z-50 flex items-end">
          ...
          <div className="relative w-full bg-white rounded-t-3xl px-5 pt-6 pb-10">
            <h3 className="font-[Fraunces] font-bold text-capp-dark text-xl mb-2">Sign out?</h3>
