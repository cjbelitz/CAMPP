...
const SAMPLE_KIDS = [
  {
    ...
    age: 9,
    avatarColor: '#F055A5',
    photo: 'https://api.dicebear.com/8.x/adventurer/svg?seed=Olivia9&backgroundColor=F055A5&backgroundType=solid',
  ...
  },
  {
    ...
    age: 12,
    avatarColor: '#7A88FE',
    photo: 'https://api.dicebear.com/8.x/adventurer/svg?seed=Noah12&backgroundColor=7A88FE&backgroundType=solid',
  ...
  },
  {
    ...
    age: 7,
    avatarColor: '#CCD537',
    photo: 'https://api.dicebear.com/8.x/adventurer/svg?seed=Lily7&backgroundColor=CCD537&backgroundType=solid',
